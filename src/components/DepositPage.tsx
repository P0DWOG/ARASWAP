    ...
    <div className="deposit">
      ...
      {poolData?.aprs?.keep?.apr.gt(Zero) &&
        myShareData?.lpTokenBalance.gt(0) && (
          <LPStakingBanner stakingLink={"https://www.gysr.io/docs/pools"} />
        )}
      {poolData?.name === VETH2_POOL_NAME &&
        myShareData?.lpTokenBalance.gt(0) && (
          <LPStakingBanner stakingLink={"https://google.com"} />
        )}
      ...
      {poolData?.name === STABLECOIN_POOL_NAME &&
        myShareData?.lpTokenBalance.gt(0) && (
          <LPStakingBanner stakingLink={"https://app.gysr.io/pool/0x3910aa5babae0468c246d859e7119565eb69fe5d"} />
        )}
          ...
          <div className="form">
            ...
            <div className={classNames("transactionInfoContainer", "show")}>
              <div className="transactionInfo">
                {poolData?.aprs?.keep?.apr.gt(Zero) && (
                  <div className="transactionInfoItem"></div>
                )}
